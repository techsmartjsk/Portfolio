  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-2'>
        <h1 className='text-3xl lg:text-5xl font-bold text-white'>Jaskirat Singh</h1>
      ...
      <a href="mailto:techsmartjsk@gmail.com" className='p-2 border-[1px] cursor-pointer text-[#64ffda] border-[#64ffda] w-fit rounded-md text-sm lg:text-[18px] px-16 py-5'>
        Get In Touch
      </a>
    </div>
  )
